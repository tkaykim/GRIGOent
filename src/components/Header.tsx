          ...
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center">
                <button
                  onClick={() => router.push('/')}
                  className="text-white text-2xl font-bold tracking-wider hover:text-white/80 transition-colors"
                >
                  GRIGO
                </button>
              </div>
            ...
            <div className="flex items-center gap-4">
              ...
              {showHamburger && (
                <button
                  ...
                  className="lg:hidden relative w-10 h-10 flex flex-col justify-center items-center bg-white/10 backdrop-blur-md border border-white/20 rounded-lg hover:bg-white/20 transition-all duration-300"
                  aria-label="Menu"
                >
        ...
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md">
          <div className="absolute top-0 left-0 h-full w-80 bg-black/95 backdrop-blur-xl border-r border-white/20">
            <div className="p-8 h-full flex flex-col">
              {/* 메뉴 헤더 */}
              <div className="mb-12">
                <h2 className="text-2xl font-black uppercase tracking-widest text-white mb-2">GRIGO</h2>
                  ...
                  {allMenuItems.map((item, index) => {
                    ...
                    return (
                      <li key={index}>
                        <button 
                          onClick={() => handleNavigation(item.path)}
                          className={`text-3xl font-bold uppercase tracking-widest transition-colors duration-300 block w-full text-left ${
                            isActive 
                              ? 'text-white' 
                              : 'text-white/70 hover:text-white'
                          }`}
                    ...
                    {user ? (
                      <div className="space-y-4">
                        ...
                        <button 
                          ...
                          className="text-3xl font-bold uppercase tracking-widest text-white/70 hover:text-white transition-colors duration-300 block w-full text-left"
                        >
                          로그아웃
                        </button>
                      </div>
