  ...
  return (
    <>
      <button
        ...
        className="px-6 py-3 rounded-full bg-white text-gray-900 text-sm font-semibold text-center shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 whitespace-nowrap"
      >
